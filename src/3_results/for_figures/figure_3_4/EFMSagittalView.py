...
file_path_2 = '../../data/ief/periorbital_conf_magnE.nii.gz'  # Replace with your file path
...
# Save the figure
# plt.savefig('StackedSlicesT1AndMagnE.png', dpi=300, bbox_inches='tight', transparent=True)
plt.show()
