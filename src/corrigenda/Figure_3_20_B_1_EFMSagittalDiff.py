...
# Load the second NIfTI file (stacked data)
file_path_3 = 'data/ief/frontal_occipital/cec_gm_wm_eb_magnE.nii.gz'  # Replace with your file path
...
plt.imshow(stacked_slices.T, cmap=blue_to_transparent_to_red, origin='lower', interpolation='nearest', vmin=-0.015, vmax=0.015)  # Adjust alpha for transparency
...
cbar.set_label('EFM (V/m)', fontsize=fs)
...
# Layout and save
plt.tight_layout()
# plt.savefig('Corrigenda Figure 3-20B1.png', dpi=300, bbox_inches='tight', transparent=True)
plt.show()
