...
file_path_2 = 'data/ief/frontal_occipital/cec_gm_wm_eb_magnE.nii.gz'  # Replace with your file path
...
# Save the figure
plt.savefig('Corrigenda Figure 3-20A2.png', dpi=300, bbox_inches='tight', transparent=True)
# plt.show()
