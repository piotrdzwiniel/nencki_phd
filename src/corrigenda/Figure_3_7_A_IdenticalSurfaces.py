...
image_path1 = 'data/ief/electrodes/cropped_periorbital_eliptical_3cm2.png'
...
# plt.savefig(f'Corrigenda Figure 3-7A IdenticalSurfaces.png', dpi=300, bbox_inches='tight', transparent=True)
plt.show()